...
-- Usage
XPerlUsageNameList	= {XPerl = "Core", XPerl_Player = "Player", XPerl_PlayerPet = "Pet", XPerl_Target = "Target", XPerl_TargetTarget = "Target's Target", XPerl_Party = "Party", XPerl_PartyPet = "Party Pets", XPerl_RaidFrames = "Raid Frames", XPerl_RaidHelper = "Raid Helper", XPerl_RaidAdmin = "Raid Admin", XPerl_TeamSpeak = "TS Monitor"}
...
if (GetLocale() == "zhCN") then
	...
	XPerl_Description       = XPerl_ProductName.." by "..XPerl_Author.." (|cFFFF8080Hughman|r 汉化修改)"
	...
	-- Usage
	XPerlUsageNameList = {XPerl = "�����ļ�", XPerl_Player = "���", XPerl_PlayerPet = "����", XPerl_Target = "Ŀ��", XPerl_TargetTarget = "Ŀ���Ŀ��", XPerl_Party = "����", XPerl_PartyPet = "���ѳ���", XPerl_RaidFrames = "�Ŷӿ�", XPerl_RaidHelper = "�Ŷ�����", XPerl_RaidAdmin = "�Ŷӹ���", XPerl_TeamSpeak = "TS Monitor"}
	XPERL_USAGE_MEMMAX 	= "UI�ڴ����ֵ %d"
	XPERL_USAGE_MODULES	= "ģ�� "
	XPERL_USAGE_NEWVERSION	= "���µİ汾"
	XPERL_USAGE_AVAILABLE	= "%s |c00FFFFFF%s|r ��������"

end
if (GetLocale() == "zhTW") then
	-- Thanks 星塵 for translations
	XPerl_Description       = XPerl_ProductName.." by "..XPerl_Author.." (|cFFFF8080星塵|r 繁化修改)"
	...
	XPERL_SPELL_SUNDER	= "破甲攻擊"
	XPERL_SPELL_SHADOWV	= "暗影易傷"
	XPERL_SPELL_FIREV	= "火焰易傷"
	XPERL_SPELL_WINTERCH	= "深冬之寒"
	...
	XPERL_USAGE_AVAILABLE	= "%s |c00FFFFFF%s|r 可下載使用"
end
